 ...
 * 
 */
public class UCRYogaThreadedClassifier extends UCRGenericClassifier {

  private static final String outputPrefix = "yoga1";
  ...
  //
  private static final int WINDOW_MIN = 380;
