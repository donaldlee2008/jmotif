 ...
 * 
 */
public class UCRYogaKNNThreaded extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "yoga_loocv_ppt";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 58;
  private static final int WINDOW_MAX = 58;
  private static final int WINDOW_INCREMENT = 1;

  private static final int PAA_MIN = 17;
  private static final int PAA_MAX = 17;
  private static final int PAA_INCREMENT = 2;

  private static final int ALPHABET_MIN = 9;
  private static final int ALPHABET_MAX = 9 ;
