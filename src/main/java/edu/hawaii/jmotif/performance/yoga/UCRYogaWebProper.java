 ...
 * 
 */
public class UCRYogaWebProper extends UCRGenericClassifier {
  ...
  private static final int[][] params = { 
    { 70, 14, 15, EXACT }, { 70, 14, 15, NOREDUCTION }, { 70, 14, 15, CLASSIC },
    
    { 58,17,9, EXACT }, { 58,17,9, NOREDUCTION }, { 58,17,9, CLASSIC },
    };
