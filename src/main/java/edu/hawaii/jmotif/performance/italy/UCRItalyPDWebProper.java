package edu.hawaii.jmotif.performance.italy;
 ...
 * 
 */
public class UCRItalyPDWebProper extends UCRGenericClassifier {
  ...
  private static final int[][] params = {
    ...
    { 12, 11, 3, CLASSIC }, { 12, 11, 3, EXACT }, { 12, 11, 3, NOREDUCTION },
    { 13, 6, 4, CLASSIC }, { 13, 6, 4, EXACT }, { 13, 6, 4, NOREDUCTION },
