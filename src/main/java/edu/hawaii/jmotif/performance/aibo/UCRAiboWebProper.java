 ...
 * 
 */
public class UCRAiboWebProper extends UCRGenericClassifier {
  ...
  private static final int[][] params = { 
    ...
    { 54,4,16, CLASSIC }, { 54,4,16, EXACT }, { 54,4,16, NOREDUCTION },
    
    { 60,5,5, CLASSIC }, { 60,5,5, EXACT }, { 60,5,5, NOREDUCTION },
