 ...
 * 
 */
public class UCRCricketDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "cricket_direct";
  ...
  private UCRCricketDirectSampler() {
    super();
  }
