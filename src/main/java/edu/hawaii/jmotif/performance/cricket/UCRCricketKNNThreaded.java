 ...
 * 
 */
public class UCRCricketKNNThreaded extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "cricket_loocv_new_threaded";
  
  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 20;
  private static final int WINDOW_MAX = 305;
