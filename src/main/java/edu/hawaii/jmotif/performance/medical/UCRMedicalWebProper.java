package edu.hawaii.jmotif.performance.medical;
 ...
 * 
 */
public class UCRMedicalWebProper extends UCRGenericClassifier {

  // data locations
  //
  private static final String TRAINING_DATA = "data/MedicalImages/MedicalImages_TRAIN";
  private static final String TEST_DATA = "data/MedicalImages/MedicalImages_TEST";

   private static final int[][] params = { 
   { 37,13,3,NOREDUCTION },{ 37,13,3, EXACT }, { 37,13,3, CLASSIC },
   { 31,8,5,NOREDUCTION },{ 31,8,5, EXACT }, { 31,8,5, CLASSIC },
   { 18,8,8,NOREDUCTION },{ 18,8,8, EXACT }, { 18,8,8, CLASSIC }
};
