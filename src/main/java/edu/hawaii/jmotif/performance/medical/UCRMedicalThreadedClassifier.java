 ...
 * 
 */
public class UCRMedicalThreadedClassifier extends UCRGenericClassifier {

  private static final String outputPrefix = "medical";
  ...
  //
  private static final int WINDOW_MIN = 66;
