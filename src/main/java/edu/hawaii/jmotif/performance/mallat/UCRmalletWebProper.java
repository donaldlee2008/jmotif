 ...
 * 
 */
public class UCRmalletWebProper extends UCRGenericClassifier {
  ...
  private static final int[][] params = {
    ...
    { 214,10,15, NOREDUCTION }, { 214,10,15, CLASSIC }, { 214,10,15, EXACT },
  
    { 210,10,13, NOREDUCTION }, { 210,10,13, CLASSIC }, { 210,10,13, EXACT },
