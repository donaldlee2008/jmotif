package edu.hawaii.jmotif.performance.italyPD;
 ...
 * 
 */
public class UCRFacesUCRWebProper extends UCRGenericClassifier {

  // data locations
  //
  private static final String TRAINING_DATA = "data/ItalyPowerDemand/ItalyPowerDemand_TRAIN";
  private static final String TEST_DATA = "data/ItalyPowerDemand/ItalyPowerDemand_TEST";

   private static final int[][] params = { 
   { 20,7,4,NOREDUCTION },{ 20,7,4, EXACT }, { 20,7,4, CLASSIC },
   { 13,6,5,NOREDUCTION },{ 13,6,5, EXACT }, { 13,6,5, CLASSIC },
   { 19,6,5,NOREDUCTION },{ 19,6,5, EXACT }, { 19,6,5, CLASSIC }
};
