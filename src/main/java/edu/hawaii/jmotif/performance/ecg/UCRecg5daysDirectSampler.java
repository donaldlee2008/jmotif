 ...
 * 
 */
public class UCRecg5daysDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "ecg5d_direct";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 5;
  private static final int WINDOW_MAX = 136;
  ...
  private UCRecg5daysDirectSampler() {
    super();
  }
