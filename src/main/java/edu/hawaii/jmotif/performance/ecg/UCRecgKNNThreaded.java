 ...
 * 
 */
public class UCRecgKNNThreaded extends UCRGenericClassifier {

  // data
  //
  private static final String TRAINING_DATA = "data/ECG200/ECG200_TRAIN";
  private static final String TEST_DATA = "data/ECG200/ECG200_TEST";

  // output prefix
  //
  private static final String outputPrefix = "ecg_loocv_threaded";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 33;
  private static final int WINDOW_MAX = 37;
  private static final int WINDOW_INCREMENT = 2;

  private static final int PAA_MIN = 7;
  private static final int PAA_MAX = 9;
  private static final int PAA_INCREMENT = 1;

  private static final int ALPHABET_MIN = 4;
  private static final int ALPHABET_MAX = 6;
