 ...
 * 
 */
public class UCRecgFiveDaysThreaded extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "ecg5d_loocv_threaded";
  ...
  private UCRecgFiveDaysThreaded() {
    super();
  }
