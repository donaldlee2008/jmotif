 ...
 * 
 */
public class UCRecgDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "ecg_direct";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 5;
  private static final int WINDOW_MAX = 96;
