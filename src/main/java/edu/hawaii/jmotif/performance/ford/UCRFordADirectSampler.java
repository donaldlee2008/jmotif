 ...
 * 
 */
public class UCRFordADirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "fordA_direct";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 30;
  private static final int WINDOW_MAX = 500;
