package edu.hawaii.jmotif.performance.face4;
 ...
 * 
 */
public class UCRface4KNNThreaded extends UCRGenericClassifier {

  // data
  //
  private static final String TRAINING_DATA = "data/FaceFour/FaceFour_TRAIN";
  private static final String TEST_DATA = "data/FaceFour/FaceFour_TEST";

  // output prefix
  //
  private static final String outputPrefix = "face4_loocv_threaded";
  ...
  private static final int PAA_MAX = 21;
