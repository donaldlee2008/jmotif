 ...
 * 
 */
public class UCRFace4WebProper extends UCRGenericClassifier {
  ...
  private static final int[][] params = { 
    { 67,7,5, NOREDUCTION }, { 67,7,5, EXACT },  { 67,7,5, CLASSIC },
    { 200,12,4, NOREDUCTION }, { 200,12,4, EXACT },  { 200,12,4, CLASSIC } };
