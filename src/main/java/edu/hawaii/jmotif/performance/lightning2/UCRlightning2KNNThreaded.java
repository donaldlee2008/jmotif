 ...
 * 
 */
public class UCRlightning2KNNThreaded extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "lightning22_loocv_threaded";
  
  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 270;
  private static final int WINDOW_MAX = 320;
  ...
  private UCRlightning2KNNThreaded() {
    super();
  }
