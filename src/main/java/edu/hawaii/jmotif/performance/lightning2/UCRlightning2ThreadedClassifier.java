 ...
 * 
 */
public class UCRlightning2ThreadedClassifier extends UCRGenericClassifier {

  private static final String outputPrefix = "lightning_explorer";
  ...
  private static final int WINDOW_MAX = 600;
