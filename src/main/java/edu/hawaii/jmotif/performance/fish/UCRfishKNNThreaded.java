 ...
 * 
 */
public class UCRfishKNNThreaded extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "fish_loocv_threaded";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 91;
  private static final int WINDOW_MAX = 109;
  private static final int WINDOW_INCREMENT = 1;

  private static final int PAA_MIN = 13;
