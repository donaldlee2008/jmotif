 ...
 * 
 */
public class UCRCoffeeDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "coffee_direct";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 10;
  private static final int WINDOW_MAX = 286;
  ...
  private UCRCoffeeDirectSampler() {
    super();
  }
