 ...
 * 
 */
public class UCRCoffeeKNNThreaded extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "coffee_loocv_threaded";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 270;
  private static final int WINDOW_MAX = 270;
  private static final int WINDOW_INCREMENT = 10;

  private static final int PAA_MIN = 21;
