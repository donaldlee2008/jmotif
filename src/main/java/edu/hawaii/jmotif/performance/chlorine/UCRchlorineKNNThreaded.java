package edu.hawaii.jmotif.performance.chlorine;
 ...
 * 
 */
public class UCRchlorineKNNThreaded extends UCRGenericClassifier {

  // data
  //
  private static final String TRAINING_DATA = "data/ChlorineConcentration/ChlorineConcentration_TRAIN";
  private static final String TEST_DATA = "data/ChlorineConcentration/ChlorineConcentration_TEST";

  // output prefix
  //
  private static final String outputPrefix = "chlorine_loocv_threaded";
  
  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 100;
  private static final int WINDOW_MAX = 160;
  private static final int WINDOW_INCREMENT = 10;

  private static final int PAA_MIN = 4;
  private static final int PAA_MAX = 24;
  private static final int PAA_INCREMENT = 2;

  private static final int ALPHABET_MIN = 2;
  private static final int ALPHABET_MAX = 18;
  private static final int ALPHABET_INCREMENT = 3;
  ...
  private UCRchlorineKNNThreaded() {
    super();
  }
