 ...
 * 
 */
public class UCRChlorineDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "chlorine_direct";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 10;
  private static final int WINDOW_MAX = 166;
  ...
  private UCRChlorineDirectSampler() {
    super();
  }
