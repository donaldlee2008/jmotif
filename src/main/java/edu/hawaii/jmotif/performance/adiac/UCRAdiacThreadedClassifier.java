 ...
 * 
 */
public class UCRAdiacThreadedClassifier extends UCRGenericClassifier {

  private static final String outputPrefix = "adiac4";
  ...
  private static final int WINDOW_MAX = 79;
  private static final int WINDOW_INCREMENT = 1;

  private static final int PAA_MIN = 20;
