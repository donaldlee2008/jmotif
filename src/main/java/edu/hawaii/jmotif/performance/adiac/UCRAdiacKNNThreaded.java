 ...
 * 
 */
public class UCRAdiacKNNThreaded extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "adiac2_loocv_threaded";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 97;
  private static final int WINDOW_MAX = 103;
  private static final int WINDOW_INCREMENT = 1;

  private static final int PAA_MIN = 22;
  private static final int PAA_MAX = 26;
  private static final int PAA_INCREMENT = 1;

  private static final int ALPHABET_MIN = 14;
