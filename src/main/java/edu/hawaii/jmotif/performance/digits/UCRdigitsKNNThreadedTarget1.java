 ...
 * 
 */
public class UCRdigitsKNNThreadedTarget1 extends UCRGenericClassifier {
  ...
  // data
  //
  private static final String TRAINING_DATA = "data/digits/digits_train.txt";
  // private static final String TEST_DATA = "data/Gun_Point/Gun_Point_TEST";
  // output prefix
  //
  private static final String outputPrefix = "digits_400loocv_train_target1";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 130;
  private static final int WINDOW_MAX = 230;
  ...
  private static final int ALPHABET_MAX = 17;
  private static final int ALPHABET_INCREMENT = 2;

  // leave out parameters
  //
  private static final int LEAVE_OUT_NUM = 50;

  private UCRdigitsKNNThreadedTarget1() {
    super();
  }
