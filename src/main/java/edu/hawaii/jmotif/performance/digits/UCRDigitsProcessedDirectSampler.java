 ...
 * 
 */
public class UCRDigitsProcessedDirectSampler extends UCRGenericClassifier {
  ...
  // data
  //
  private static final String TRAINING_DATA = "data/digits/digits_processed_50.csv";

  // output prefix
  //
  private static final String outputPrefix = "digits_direct_processed";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 20;
  private static final int WINDOW_MAX = 80;
  ...
  private UCRDigitsProcessedDirectSampler() {
    super();
  }
