...
public class DigitsJob implements Callable<String> {
  ...
  public DigitsJob(double[] series, int seriesCounter, Map<String, WordBag> bags, int[] p) {
    this.series = series;
    this.bags = bags;
    this.params = p;
  ...
  public String call() throws Exception {
    return getVotes(getNeighbors(
        seriesToWordBag("test", this.series, this.params, SAXCollectionStrategy.NOREDUCTION),
        this.bags, this.params));
  }
