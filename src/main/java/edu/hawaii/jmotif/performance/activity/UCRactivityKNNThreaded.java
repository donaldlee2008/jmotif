package edu.hawaii.jmotif.performance.activity;
 ...
 * 
 */
public class UCRactivityKNNThreaded extends UCRGenericClassifier {

  // data
  //
  private static final String TRAINING_DATA = "data/AIBO/Sony_TRAIN";
  private static final String TEST_DATA = "data/AIBO/Sony_TEST";

  // output prefix
  //
  private static final String outputPrefix = "aibo_loocv_threaded";
  ...
  private UCRactivityKNNThreaded() {
    super();
  }
