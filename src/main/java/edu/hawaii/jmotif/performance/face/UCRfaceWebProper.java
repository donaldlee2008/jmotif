 ...
 * 
 */
public class UCRfaceWebProper extends UCRGenericClassifier {
  ...
  private static final int[][] params = { 
    {41,8,4, NOREDUCTION }, { 41,8,4, EXACT },  { 41,8,4, CLASSIC },
    {47,8,4, NOREDUCTION }, { 42,8,4, EXACT },  { 42,8,4, CLASSIC },
