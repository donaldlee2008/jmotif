package edu.hawaii.jmotif.performance.face;
 ...
 * 
 */
public class UCRFaceDirectSampler extends UCRGenericClassifier {
  ...
  // data
  //
  private static final String TRAINING_DATA = "data/FaceAll/FaceAll_TRAIN";

  // output prefix
  //
  private static final String outputPrefix = "face_direct";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 20;
  private static final int WINDOW_MAX = 130;
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      while (totalTaskCounter > 0) {
        ...
        Future<List<String>> finished = completionService.poll(240, TimeUnit.HOURS);
        if (null == finished) {
          // something went wrong - break from here
          System.err.println("Breaking POLL loop after 240 HOURS of waiting...");
          break;
        }
        else {
