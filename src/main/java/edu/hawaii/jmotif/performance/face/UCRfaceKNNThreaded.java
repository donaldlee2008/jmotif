 ...
 * 
 */
public class UCRfaceKNNThreaded extends UCRGenericClassifier {

  // data
  //
  private static final String TRAINING_DATA = "data/FaceAll/FaceAll_TRAIN";
  private static final String TEST_DATA = "data/FaceAll/FaceAll_TEST";

  // output prefix
  //
  private static final String outputPrefix = "face1_loocv_threaded";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 49;
  private static final int WINDOW_MAX = 125;
