package edu.hawaii.jmotif.performance.starlightcurves;
 ...
 * 
 */
public class UCRStarlightCurvesWebProper extends UCRGenericClassifier {

  // data locations
  //
  private static final String TRAINING_DATA = "data/StarLightCurves/StarLightCurves_TRAIN";
  private static final String TEST_DATA = "data/StarLightCurves/StarLightCurves_TEST";

   private static final int[][] params = { 
   
   { 172,15,11,NOREDUCTION },{ 172,15,11, EXACT }, { 172,15,11, CLASSIC },
   { 286,7,12,NOREDUCTION },{ 286,7,12, EXACT }, { 286,7,12, CLASSIC },
   { 286,29,5,NOREDUCTION },{ 286,29,5, EXACT }, { 286,29,5, CLASSIC },
   { 286,41,5,NOREDUCTION },{ 286,41,5, EXACT }, { 286,41,5, CLASSIC },
