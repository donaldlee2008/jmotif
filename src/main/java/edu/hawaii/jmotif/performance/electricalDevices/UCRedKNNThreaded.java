 ...
 * 
 */
public class UCRedKNNThreaded extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "ed_loocv_threaded";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 17;
  ...
  //
  private static final int HOLD_OUT_NUM = 10;
  private static final int THREADS_NUM = 8;

  private UCRedKNNThreaded() {
    super();
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    consoleLogger.fine("strategy: " + strategyPrefix + ", leaving out: " + HOLD_OUT_NUM);
    ...
    List<String> result = trainKNNFoldJMotifThreaded(THREADS_NUM, window_sizes, paa_sizes,
        alphabet_sizes, strategy, trainData, HOLD_OUT_NUM);
