 ...
 * 
 */
public class UCRedDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "ed_direct";
