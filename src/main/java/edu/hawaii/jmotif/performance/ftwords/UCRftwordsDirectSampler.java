 ...
 * 
 */
public class UCRftwordsDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "ftwords_direct";
  ...
  private UCRftwordsDirectSampler() {
    super();
  }
