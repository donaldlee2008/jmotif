package edu.hawaii.jmotif.performance.ftwords;
 ...
 * 
 */
public class UCR50wordsWebProper extends UCRGenericClassifier {

  // prefix for all of the output
  private static final String TRAINING_DATA = "data/50words/50words_TRAIN";
  private static final String TEST_DATA = "data/50words/50words_TEST";

  // SAX parameters to try
  //
  private static final int[][] params = { 
    
    { 176, 8, 3, CLASSIC }, { 176, 8, 3, EXACT }, { 176, 8, 3, NOREDUCTION },
    { 201, 10, 4, CLASSIC }, { 201, 10, 4, EXACT }, { 201, 10, 4, NOREDUCTION },
    { 126, 7, 4, CLASSIC }, { 126, 7, 4, EXACT }, { 126, 7, 4, NOREDUCTION },
        
    { 190,10,3,CLASSIC }, { 190,10,3, EXACT }, { 190,10,3, NOREDUCTION },
  };
