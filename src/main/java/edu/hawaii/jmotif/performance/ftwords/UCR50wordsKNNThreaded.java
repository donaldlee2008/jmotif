 ...
 * 
 */
public class UCR50wordsKNNThreaded extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "ftwords1_loocv";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 190;
