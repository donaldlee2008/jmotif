 ...
 * 
 */
public class UCRSyntheticDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "synthetic_direct";
  ...
  private UCRSyntheticDirectSampler() {
    super();
  }
