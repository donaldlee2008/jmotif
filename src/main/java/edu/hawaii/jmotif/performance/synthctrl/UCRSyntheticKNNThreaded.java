 ...
 * 
 */
public class UCRSyntheticKNNThreaded extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "synthetic_loocv_threaded_1";
  
  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 10;
  private static final int WINDOW_MAX = 55;
  ...
  private UCRSyntheticKNNThreaded() {
    super();
  }
