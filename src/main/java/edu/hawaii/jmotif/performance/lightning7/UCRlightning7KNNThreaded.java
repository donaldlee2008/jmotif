package edu.hawaii.jmotif.performance.lightning7;
 ...
 * 
 */
public class UCRlightning7KNNThreaded extends UCRGenericClassifier {

  // data
  //
  private static final String TRAINING_DATA = "data/Lighting7/Lighting7_TRAIN";
  private static final String TEST_DATA = "data/Lighting7/Lighting7_TEST";

  // output prefix
  //
  private static final String outputPrefix = "lightning72_loocv_threaded";
  
  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 45;
  private static final int WINDOW_MAX = 75;
  ...
  private UCRlightning7KNNThreaded() {
    super();
  }
