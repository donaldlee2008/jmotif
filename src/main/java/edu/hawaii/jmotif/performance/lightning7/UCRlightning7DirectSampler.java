 ...
 * 
 */
public class UCRlightning7DirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "lightning7_direct";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 20;
  private static final int WINDOW_MAX = 319;
  ...
  private UCRlightning7DirectSampler() {
    super();
  }
