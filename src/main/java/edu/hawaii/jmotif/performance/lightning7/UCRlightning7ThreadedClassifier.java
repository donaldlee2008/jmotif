 ...
 * 
 */
public class UCRlightning7ThreadedClassifier extends UCRGenericClassifier {

  private static final String outputPrefix = "lightning7";
  ...
  private static final int WINDOW_MAX = 310;
