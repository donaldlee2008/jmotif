 ...
 * 
 */
public class UCRswdleafKNNThreaded extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "swdleaf2_loocv_threaded";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 41;
  private static final int WINDOW_MAX = 53;
  ...
  private static final int ALPHABET_MIN = 7;
  private static final int ALPHABET_MAX = 14;
