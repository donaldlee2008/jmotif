 ...
 * 
 */
public class UCRswdleafDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "SwedishLeaf_direct";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 20;
  private static final int WINDOW_MAX = 127;
  ...
  private UCRswdleafDirectSampler() {
    super();
  }
