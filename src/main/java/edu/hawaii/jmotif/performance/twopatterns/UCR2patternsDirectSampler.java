 ...
 * 
 */
public class UCR2patternsDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "2patterns_direct";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 10;
  private static final int WINDOW_MAX = 128;
  ...
  private UCR2patternsDirectSampler() {
    super();
  }
