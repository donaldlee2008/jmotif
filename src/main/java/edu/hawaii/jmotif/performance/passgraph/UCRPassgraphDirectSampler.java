 ...
 * 
 */
public class UCRPassgraphDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "passgraph_direct";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 5;
  private static final int WINDOW_MAX = 364;
  ...
  private UCRPassgraphDirectSampler() {
    super();
  }
