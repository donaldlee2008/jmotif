 ...
 * 
 */
public class UCRPassgraphThreadedClassifier extends UCRGenericClassifier {

  private static final String outputPrefix = "passgraph";
  ...
  //
  private static final int WINDOW_MIN = 12;
  private static final int WINDOW_MAX = 68;
