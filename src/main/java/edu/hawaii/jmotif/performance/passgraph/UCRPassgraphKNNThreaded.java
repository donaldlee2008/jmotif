package edu.hawaii.jmotif.performance.passgraph;
 ...
 * 
 */
public class UCRPassgraphKNNThreaded extends UCRGenericClassifier {

  // data
  //
  private static final String TRAINING_DATA = "data/Passgraph/Passgraph_TRAIN";
  private static final String TEST_DATA = "data/Passgraph/Passgraph_TEST";

  // output prefix
  //
  private static final String outputPrefix = "passgraph_loocv_threaded";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 20;
  private static final int WINDOW_MAX = 350;
  private static final int WINDOW_INCREMENT = 5;

  private static final int PAA_MIN = 9;
  private static final int PAA_MAX = 32;
  ...
  private UCRPassgraphKNNThreaded() {
    super();
  }
