 ...
 * 
 */
public class UCRpostgreThreadedClassifier extends UCRGenericClassifier {

  private static final String outputPrefix = "postgre";
  private static final int MAX_THREADS = 6;

  // data locations
  private static final String TRAINING_DATA = "data/postgre-train.txt";
  private static final String TEST_DATA = "data/postgre-test.txt";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 3;
  private static final int WINDOW_MAX = 85;
