 ...
 * 
 */
public class UCRpostgreKNNThreaded extends UCRGenericClassifier {

  // data
  //
  private static final String TRAINING_DATA = "data/android/three_releases_train";

  // output prefix
  //
  private static final String outputPrefix = "android_loocv_threaded";
  ...
  private static final int PAA_MAX = 7;
