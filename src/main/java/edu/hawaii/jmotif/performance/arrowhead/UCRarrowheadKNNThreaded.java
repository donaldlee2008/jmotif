 ...
 * 
 */
public class UCRarrowheadKNNThreaded extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "arrowhead1_loocv_threaded";
  ...
  private static final int PAA_MAX = 14;
  ...
  private UCRarrowheadKNNThreaded() {
    super();
  }
