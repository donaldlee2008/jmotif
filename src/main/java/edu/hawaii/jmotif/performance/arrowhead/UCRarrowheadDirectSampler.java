 ...
 * 
 */
public class UCRarrowheadDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "arrowhead_direct";
  ...
  private UCRarrowheadDirectSampler() {
    super();
  }
