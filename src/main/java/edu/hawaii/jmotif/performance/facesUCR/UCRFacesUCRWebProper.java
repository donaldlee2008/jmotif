package edu.hawaii.jmotif.performance.facesUCR;
...
public class UCRFacesUCRWebProper extends UCRGenericClassifier {
  ...
  // data locations
  //
  private static final String TRAINING_DATA = "data/DiatomSizeReduction/DiatomSizeReduction_TRAIN";
  private static final String TEST_DATA = "data/DiatomSizeReduction/DiatomSizeReduction_TEST";

   private static final int[][] params = { 
   { 174,15,18,NOREDUCTION },{ 174,15,18, EXACT }, { 174,15,18, CLASSIC }
};
