 ...
 * 
 */
public class UCRPhysioWebProper extends UCRGenericClassifier {

  // data locations
  //
  private static final String TRAINING_DATA = "data/PHYSIO_TRAIN.csv";
  private static final String TEST_DATA = "data/PHYSIO_TEST.csv";
