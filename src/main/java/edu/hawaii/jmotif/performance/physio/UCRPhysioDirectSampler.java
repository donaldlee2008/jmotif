package edu.hawaii.jmotif.performance.physio;
 ...
 * 
 */
public class UCRPhysioDirectSampler extends UCRGenericClassifier {
  ...
  // data
  //
  private static final String TRAINING_DATA = "data/PHYSIO_CLUSTER.csv";

  // output prefix
  //
  private static final String outputPrefix = "physio1";
  ...
  private UCRPhysioDirectSampler() {
    super();
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (Entry<String, List<double[]>> e : trainData.entrySet()) {
      ...
      for (int i = 0; i < 30; i++) {
        newEntry.add(Arrays.copyOf(e.getValue().get(i), 1000));
      }
      e.setValue(newEntry);
    }
