 ...
 * 
 */
public class UCRshieldWebProper extends UCRGenericClassifier {
  ...
  private static final int[][] params = {
    ...
    { 186,10,3, NOREDUCTION }, { 186,10,3, CLASSIC }, { 186,10,3, EXACT },
    
    { 150,12,4, NOREDUCTION }, { 150,12,4, CLASSIC }, { 150,12,4, EXACT },
