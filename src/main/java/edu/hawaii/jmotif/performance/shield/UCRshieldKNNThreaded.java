package edu.hawaii.jmotif.performance.shield;
 ...
 * 
 */
public class UCRshieldKNNThreaded extends UCRGenericClassifier {

  // data
  //
  private static final String TRAINING_DATA = "data/shield/shield_train";
  private static final String TEST_DATA = "data/shield/shield_test";

  // output prefix
  //
  private static final String outputPrefix = "shield1_loocv_threaded";
  
  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 130;
  private static final int WINDOW_MAX = 170;
  ...
  private static final int ALPHABET_MAX = 8;
