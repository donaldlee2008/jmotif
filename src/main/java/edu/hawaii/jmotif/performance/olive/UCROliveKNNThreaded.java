 ...
 * 
 */
public class UCROliveKNNThreaded extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "olive1_loocv_threaded";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 400;
  private static final int WINDOW_MAX = 400;
  private static final int WINDOW_INCREMENT = 1;

  private static final int PAA_MIN = 58;
  private static final int PAA_MAX = 58;
