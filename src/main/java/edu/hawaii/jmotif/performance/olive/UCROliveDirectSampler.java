 ...
 * 
 */
public class UCROliveDirectSampler extends UCRGenericClassifier {
  ...
  private static final int WINDOW_MAX = 570;

  private static final int PAA_MIN = 5;
  private static final int PAA_MAX = 70;
