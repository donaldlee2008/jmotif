 ...
 * 
 */
public class UCROlivePatternsHunter extends UCRGenericClassifier {
  ...
  //
  private static final int[][] params = { { 370, 50, 6, EXACT } };


  private static final int MAX_Patterns_2PRINT = 2;
