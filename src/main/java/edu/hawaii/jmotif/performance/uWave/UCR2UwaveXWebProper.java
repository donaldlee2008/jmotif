 ...
 * 
 */
public class UCR2UwaveXWebProper extends UCRGenericClassifier {

  // data locations
  //
  private static final String TRAINING_DATA = "data/uWaveGestureLibrary_X/uWaveGestureLibrary_X_TRAIN";
  private static final String TEST_DATA = "data/uWaveGestureLibrary_X/uWaveGestureLibrary_X_TEST";

  // SAX parameters to try
  //

  private static final int[][] params = { 
      { 260,7,5, NOREDUCTION }, { 260,7,5, CLASSIC }, { 260,7,5, EXACT },
      { 251,8,5, NOREDUCTION }, { 251,8,5, CLASSIC }, { 251,8,5, EXACT },
      { 193,4,17, NOREDUCTION }, { 193,4,17, CLASSIC }, { 193,4,17, EXACT },
