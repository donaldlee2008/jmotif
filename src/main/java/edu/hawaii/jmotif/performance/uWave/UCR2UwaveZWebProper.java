 ...
 * 
 */
public class UCR2UwaveZWebProper extends UCRGenericClassifier {

  // data locations
  //
  private static final String TRAINING_DATA = "data/uWaveGestureLibrary_Z/uWaveGestureLibrary_Z_TRAIN";
  private static final String TEST_DATA = "data/uWaveGestureLibrary_Z/uWaveGestureLibrary_Z_TEST";

  // SAX parameters to try
  //

  private static final int[][] params = { 
      { 258,8,4, NOREDUCTION }, { 258,8,4, CLASSIC }, { 258,8,4, EXACT },
