package edu.hawaii.jmotif.performance.words;
 ...
 * 
 */
public class UCRWordsWebProper extends UCRGenericClassifier {

  // data locations
  //
  private static final String TRAINING_DATA = "data/WordsSynonyms/WordsSynonyms_TRAIN";
  private static final String TEST_DATA = "data/WordsSynonyms/WordsSynonyms_TEST";

   private static final int[][] params = { 
   { 198,10,3,NOREDUCTION },{ 198,10,3, EXACT }, { 198,10,3, CLASSIC },
   { 200,10,3,NOREDUCTION },{ 200,10,3, EXACT }, { 200,10,3, CLASSIC },
   { 146,10,3,NOREDUCTION },{ 146,10,3, EXACT }, { 146,10,3, CLASSIC },
};
