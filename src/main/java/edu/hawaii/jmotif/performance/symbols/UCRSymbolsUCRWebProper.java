package edu.hawaii.jmotif.performance.symbols;
 ...
 * 
 */
public class UCRSymbolsUCRWebProper extends UCRGenericClassifier {

  // data locations
  //
  private static final String TRAINING_DATA = "data/Symbols/Symbols_TRAIN";
  private static final String TEST_DATA = "data/Symbols/Symbols_TEST";

   private static final int[][] params = { 
   
   { 112,12,5,NOREDUCTION },{ 112,12,5, EXACT }, { 112,12,5, CLASSIC },
   { 127,25,5,NOREDUCTION },{ 127,25,5, EXACT }, { 127,25,5, CLASSIC }
