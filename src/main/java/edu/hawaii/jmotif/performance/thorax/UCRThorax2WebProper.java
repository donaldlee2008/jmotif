 ...
 * 
 */
public class UCRThorax2WebProper extends UCRGenericClassifier {

  // data locations
  //
  private static final String TRAINING_DATA = "data/NonInvasiveFatalECG/NonInvasiveFatalECG _Thorax2TRAIN.txt";
  private static final String TEST_DATA = "data/NonInvasiveFatalECG/NonInvasiveFatalECG _Thorax2TEST.txt";

  private static final int[][] params = {

  { 44, 15, 14, NOREDUCTION }, { 44, 15, 14, EXACT }, { 44, 15, 14, CLASSIC },
  { 127, 15, 11, NOREDUCTION }, { 127, 15, 11, EXACT }, { 127, 15, 11, CLASSIC },
