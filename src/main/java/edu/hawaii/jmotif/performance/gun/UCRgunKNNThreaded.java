package edu.hawaii.jmotif.performance.gun;
 ...
 * 
 */
public class UCRgunKNNThreaded extends UCRGenericClassifier {
  ...
  // data
  //
  private static final String TRAINING_DATA = "data/Gun_Point/Gun_Point_TRAIN";
  private static final String TEST_DATA = "data/Gun_Point/Gun_Point_TEST";
  // output prefix
  //
  private static final String outputPrefix = "gun_loocv";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 34;
  private static final int WINDOW_MAX = 36;
  ...
  private static final int ALPHABET_MAX = 7;
