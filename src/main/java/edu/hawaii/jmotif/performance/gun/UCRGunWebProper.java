 ...
 * 
 */
public class UCRGunWebProper extends UCRGenericClassifier {
  ...
  private static final int[][] params = {
    { 80, 22, 11, CLASSIC }, { 80, 22, 11, EXACT }, { 80, 22, 11, NOREDUCTION },
    { 32, 12, 9, CLASSIC }, { 32, 12, 9, EXACT }, { 32, 12, 9, NOREDUCTION }, };
