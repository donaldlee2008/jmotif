package edu.hawaii.jmotif.performance.osuleaf;
 ...
 * 
 */
public class UCRosuleafKNNThreaded extends UCRGenericClassifier {

  // data
  //
  private static final String TRAINING_DATA = "data/OSULeaf/OSULeaf_TRAIN";
  private static final String TEST_DATA = "data/OSULeaf/OSULeaf_TEST";

  // output prefix
  //
  private static final String outputPrefix = "osuleaf_loocv_threaded";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 35;
  private static final int WINDOW_MAX = 35;
  private static final int WINDOW_INCREMENT = 5;

  private static final int PAA_MIN = 9;
  private static final int PAA_MAX = 9;
  private static final int PAA_INCREMENT = 3;

  private static final int ALPHABET_MIN = 19;
