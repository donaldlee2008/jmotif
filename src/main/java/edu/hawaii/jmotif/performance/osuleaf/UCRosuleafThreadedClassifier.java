 ...
 * 
 */
public class UCRosuleafThreadedClassifier extends UCRGenericClassifier {

  private static final String outputPrefix = "osuleaf";
  ...
  private static final int WINDOW_MAX = 420;
