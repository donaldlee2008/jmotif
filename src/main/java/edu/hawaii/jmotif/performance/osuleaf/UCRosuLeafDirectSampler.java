 ...
 * 
 */
public class UCRosuLeafDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "osuLeaf_direct";

  // SAX parameters to use
  //
  private static final int WINDOW_MIN = 10;
  private static final int WINDOW_MAX = 425;
  ...
  private UCRosuLeafDirectSampler() {
    super();
  }
