 ...
 * 
 */
public class UCRosuleafPatternsHunter extends UCRGenericClassifier {
  ...
  //
  private static final int[][] params = { { 50, 13, 8, NOREDUCTION } };

  private static final int MAX_PATTERNS_2PRINT = 3;
  private static final int MAX_SERIES_2PRINT = 5;
  private static final String CLASS_UNDER_INVESTIGATION = "6";
