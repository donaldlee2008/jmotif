 ...
 * 
 */
public class UCRosuleafWebProper extends UCRGenericClassifier {
  ...
  private static final int[][] params = {
    { 33, 8, 12, CLASSIC }, { 33, 8, 12, EXACT }, { 33, 8, 12, NOREDUCTION },
    { 50, 11, 8, CLASSIC }, { 50, 11, 8, EXACT }, { 50, 11, 8, NOREDUCTION },
    };
