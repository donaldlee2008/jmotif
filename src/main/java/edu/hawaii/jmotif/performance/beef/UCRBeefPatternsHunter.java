 ...
 * 
 */
public class UCRBeefPatternsHunter extends UCRGenericClassifier {
  ...
  //
  private static final int[][] params = { { 21, 14, 7, NOREDUCTION } };

  // defines the amount of words from each class's vector to print
  //
  private static final int MAX_WORDS_2_PRINT = 15;
