 ...
 * 
 */
public class UCRBeefKNNThreaded extends UCRGenericClassifier {

  // data
  //
  private static final String TRAINING_DATA = "data/Beef/Beef_TRAIN1";

  // output prefix
  //
  private static final String outputPrefix = "beef_loocv_threaded1";
