 ...
 * 
 */
public class UCRcbfExperiment extends UCRGenericClassifier {

  private static final int[][] params = { { 35, 4, 12, NOREDUCTION }, { 55, 4, 12, NOREDUCTION } };
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (int[] p : params) {
      ...
      // report results
      System.out.println(toLogStr(p, accuracy, error) + ", time "
          + String.valueOf(jmotifFinish - jmotifStart));
    }
