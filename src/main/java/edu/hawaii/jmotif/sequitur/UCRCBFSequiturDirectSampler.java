 ...
 * 
 */
public class UCRCBFSequiturDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "cbf_direct_sequitur";
  ...
  private UCRCBFSequiturDirectSampler() {
    super();
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    //
    ObjectiveFunction noredFunction = new SequiturLOOCVErrorFunction();
    ...
    //
    ObjectiveFunction exactFunction = new SequiturLOOCVErrorFunction();
    ...
    //
    ObjectiveFunction classicFunction = new SequiturLOOCVErrorFunction();
