 ...
 * 
 */
public class UCRCBFSaxVsmDirectSampler extends UCRGenericClassifier {
  ...
  // output prefix
  //
  private static final String outputPrefix = "cbf_direct_sax_vsm";
  ...
  private UCRCBFSaxVsmDirectSampler() {
    super();
  }
