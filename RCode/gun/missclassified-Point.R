...
class=2
frame=32
bestp_series = c(1,2,3,5,7)
bestp_offsets = c(99,93,82,114,95)
bestp_plot=plotwords(datTRAIN, class, frame, bestp_series, bestp_offsets, paste("Best patterns, Point"))
bestp_plot
#
# second best
second_series = c(1,2,3,5,6)
second_offsets = c(38,33,27,6,7)
secondp_plot=plotwords(datTRAIN, class, frame, second_series, second_offsets, paste("Second best pattern, Point"))
secondp_plot
#
thirdp_series = c(1,2,3,4,9)
thirdp_offsets = c(39,34,28,28,29)
thirdp_plot=plotwords(datTRAIN, class, frame, thirdp_series, thirdp_offsets, paste("Third best pattern, Point"))
thirdp_plot
#
missclassified=c(70)
...
Cairo(width = 1000, height = 800, file="gun/Point-words.png", type="png", pointsize=12, 
