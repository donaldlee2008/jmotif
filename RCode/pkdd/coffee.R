...
p = ggplot(dm, aes(x = index, y = value, group = X2, color=X2)) + 
  ...
  ggtitle("Best class-characteristic subsequences - Chlorogenic acid") +
...
p2 = ggplot(dm, aes(x = x, y = value, group = series, color=series)) + 
  geom_line()+ theme_bw() + ggtitle("Robusta") +
#  scale_colour_discrete(name = "Series index:",
#    guide = guide_legend(title.theme=element_text(size=14, angle=0),
#    keywidth = 1, keyheight = 1.5, label.theme=element_text(size=14, angle=0))) +
...
p4 = ggplot(dm, aes(x = x, y = value, group = series, color=series)) + 
  geom_line()+ theme_bw() + ggtitle("Arabica") +
  #  scale_colour_discrete(name = "Series index:",
  #    guide = guide_legend(title.theme=element_text(size=14, angle=0),
  #    keywidth = 1, keyheight = 1.5, label.theme=element_text(size=14, angle=0))) +
  theme(plot.title=element_text(size=24), legend.position="none",
        axis.title=element_blank(), axis.ticks=element_blank(),
        panel.grid.major.y = element_blank(),panel.grid.minor.y = element_blank(),
        axis.text=element_blank(), plot.margin = unit(c(0,0,0,0), "lines"))
p4
#p2$heights[[2]] <- p2$heights[[2]]+unit(0.5, "lines")
#print(arrangeGrob(p3, p4, ncol=2, widths=c(5/7, 2/7)))
#print(arrangeGrob(p, p2, p3, p4, ncol=2, widths=c(5/7, 2/7)))

g1=arrangeGrob(p4, p2, ncol=1, heights=c(4.6/10, 5.4/10))
g2=arrangeGrob(p, g1, widths=c(5/7, 2/7), ncol=2)
print(g2)
#
#
#
...
p5 = ggplot(dm, aes(x = index, y = value, group = X2, color=X2)) + 
  geom_line()+ geom_line(data=dm2,lwd=3) + theme_bw() +
  ggtitle("Second to best class-characteristic subsequences - Caffeine") +
  scale_x_continuous(expand=c(0.01,0.01),"Wavenumbers", limits=range(dm2$index),
                     breaks=c(seq(0,286,52)),labels=paste(c(seq(800,1800,200)))) + 
  #  scale_x_continuous(expand=c(0.01,0.01),"Wavenumbers", limits=range(dm2$index),
  #    breaks=c(seq(0,286,52)),labels=paste(c(seq(800,1800,200)))) + 
  ...
  theme(plot.title=element_text(size=22), legend.position="none",
        axis.title.y=element_blank(), axis.ticks.y=element_blank(),
        panel.grid.major.y = element_blank(),panel.grid.minor.y = element_blank(),
        axis.text.y=element_blank(),plot.margin = unit(c(0,0,0,0), "lines"))
p5
#
subseries=znorm(as.numeric((pre_series[1,])[(offsets[1]):(offsets[1]+frame)]))
for(i in 2:(length(offsets))){
...
dm=melt(subseries)
names(dm)=c("series","x","value")
p6 = ggplot(dm, aes(x = x, y = value, group = series, color=series)) + 
  geom_line()+ theme_bw() + ggtitle("Arabica") +
  #  scale_colour_discrete(name = "Series index:",
  #    guide = guide_legend(title.theme=element_text(size=14, angle=0),
  #    keywidth = 1, keyheight = 1.5, label.theme=element_text(size=14, angle=0))) +
  theme(plot.title=element_text(size=24), legend.position="none",
        ...
        panel.grid.major.y = element_blank(),panel.grid.minor.y = element_blank(),
        axis.text=element_blank(), plot.margin = unit(c(0,0,0,0), "lines"))
#p6 <- ggplot_gtable(ggplot_build(p2))
#p2$heights[[2]] <- p2$heights[[2]]+unit(0.5, "lines")
print(arrangeGrob(p5, p6, ncol=2, widths=c(5/7, 2/7)))
...
p7 = ggplot(dm, aes(x = index, y = value, group = X2, color=X2)) + 
  geom_line()+ geom_line(data=dm2,lwd=3) + theme_bw() +
...
dm=melt(subseries)
names(dm)=c("series","x","value")
p8 = ggplot(dm, aes(x = x, y = value, group = series, color=series)) + 
  geom_line()+ theme_bw() + ggtitle("Robusta") +
  #  scale_colour_discrete(name = "Series index:",
  #    guide = guide_legend(title.theme=element_text(size=14, angle=0),
  #    keywidth = 1, keyheight = 1.5, label.theme=element_text(size=14, angle=0))) +
...
g3=arrangeGrob(p6, p8, ncol=1, heights=c(4.6/10, 5.4/10))
g4=arrangeGrob(p5, g3, widths=c(5/7, 2/7), ncol=2)
print(g4)
...
print(arrangeGrob(g2, g4, ncol=1))
dev.off()
