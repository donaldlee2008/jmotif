...
#
#
dat = read.table(file="../direct/lightning7_direct.csv",sep=",")
...
cbf.d.nored[rev(order(cbf.d.nored[5])),]


Cairo(width = 900, height = 350, file="jcool/lightning7-direct.png", type="png", pointsize=12, 
