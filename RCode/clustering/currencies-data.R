#http://timelyportfolio.blogspot.fr/2011/05/clustering-with-currencies-and-fidelity.html
...
#on currency data and fidelity mutual fund data   
require(quantmod)   #get currency data from the FED FRED data series
Korea  <-  getSymbols("DEXKOUS",src="FRED",auto.assign=FALSE) #load Korea
write(Korea, file = "clustering/Korea.dat", ncolumns=1,append = FALSE, sep = ",")

Malaysia  <-  getSymbols("DEXMAUS",src="FRED",auto.assign=FALSE) #load Malaysia
write(Malaysia, file = "clustering/Malaysia.dat", ncolumns=1,append = FALSE, sep = ",")

Singapore  <-  getSymbols("DEXSIUS",src="FRED",auto.assign=FALSE) #load Singapore
write(Singapore, file = "clustering/Singapore.dat", ncolumns=1,append = FALSE, sep = ",")

Taiwan  <-  getSymbols("DEXTAUS",src="FRED",auto.assign=FALSE) #load Taiwan
write(Taiwan, file = "clustering/Taiwan.dat", ncolumns=1,append = FALSE, sep = ",")

China  <-  getSymbols("DEXCHUS",src="FRED",auto.assign=FALSE) #load China
write(China, file = "clustering/China.dat", ncolumns=1,append = FALSE, sep = ",")

Japan  <-  getSymbols("DEXJPUS",src="FRED",auto.assign=FALSE) #load Japan
write(Japan, file = "clustering/Japan.dat", ncolumns=1,append = FALSE, sep = ",")

Thailand  <-  getSymbols("DEXTHUS",src="FRED",auto.assign=FALSE) #load Thailand
write(Thailand, file = "clustering/Thailand.dat", ncolumns=1,append = FALSE, sep = ",")

Brazil  <-  getSymbols("DEXBZUS",src="FRED",auto.assign=FALSE) #load Brazil
write(Brazil, file = "clustering/Brazil.dat", ncolumns=1,append = FALSE, sep = ",")

Mexico  <-  getSymbols("DEXMXUS",src="FRED",auto.assign=FALSE) #load Mexico
write(Mexico, file = "clustering/Mexico.dat", ncolumns=1,append = FALSE, sep = ",")

India  <-  getSymbols("DEXINUS",src="FRED",auto.assign=FALSE) #load India
write(India, file = "clustering/India.dat", ncolumns=1,append = FALSE, sep = ",")

USDOther  <-  getSymbols("DTWEXO",src="FRED",auto.assign=FALSE) #load US Dollar Other Trading Partners
write(USDOther, file = "clustering/USDOther.dat", ncolumns=1,append = FALSE, sep = ",")
...
write(USDBroad, file = "clustering/USDBroad.dat", ncolumns=1,append = FALSE, sep = ",")
