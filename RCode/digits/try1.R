...
dat = read.csv("data/digits/train.txt",sep=" ")
...
write(t(reduced),file="digits_reduced_1000.csv",ncolumns=785)
write(t(reduced),file="digits_reduced_400.csv",ncolumns=785)
