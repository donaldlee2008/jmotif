...
threshold_error=0.6
#
data1=read.csv("../results/beef/nored.csv",head=F)
#
names(data1)=c("iteration","strategy","Window","PAA","Alphabet","Error")
#
# cut the num of iterations
#
dat1=data1[data1[,1] < threshold_iterations,]
#
# order by error ASC
#
dat1=dat1[order(dat1[,6]),]
#
